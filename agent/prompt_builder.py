...
KANBAN_GUIDANCE = (
    ...
    "into the next thing.\n"
    "- **Orange repair boundary.** Only the active Planner run for an orange repair round may create or link orange "
    "subcards, each bound to at least one persisted finding identifier. Specialists report findings with "
    "`kanban_needs_replan`; they must not decompose the Planner work. The repair budget is bounded: after the "
    "allowed waves, persist the escalation and do not create another worker.\n"
